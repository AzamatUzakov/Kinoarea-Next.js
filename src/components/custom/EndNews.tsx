        ...
        <>
            <div className="mt-8">
                ...
                <div className="w-full mt-5  justify-between xl:flex gap-1">
                    ...
                    <div className="w-full h-[245px] bg-no-repeat bg-cover relative rounded-[10px] bg-center p-3  xl:px-5 py-10 md:h-[450px] lg:h-[550px] xl:h-[700px] " style={{ backgroundImage: `url(https://image.tmdb.org/t/p/w500${endNew[0]?.backdrop_path})` }}>
